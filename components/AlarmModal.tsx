...
export const AlarmModal: React.FC<AlarmModalProps> = ({ alarm, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-[600px] bg-[#2a2a2a] rounded-lg shadow-[0_0_50px_rgba(0,0,0,0.8)] border-2 border-gray-600 overflow-hidden animate-in zoom-in-95 duration-300">
        ...
        <div className="px-8 pb-10 pt-6 flex gap-6">
